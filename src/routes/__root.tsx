...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Workshop online e ao vivo de Inteligência Artificial aplicada ao trabalho e aos negócios." },
      { name: "author", content: "IA na Prática" },
      { property: "og:title", content: "Workshop de IA para Negócios" },
